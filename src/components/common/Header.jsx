  ...
  return (
    <>
      <header className="fixed bg-[#31323D]/95 text-[#F6F5E8] font-arimo left-0 top-0 z-50 w-full px-5 py-4 md:px-12">
        <nav className="mx-auto flex container items-center justify-between rounded-full border border-white/10 bg-[#31323D]/50 px-5 py-3 shadow-2xl backdrop-blur-xl">
